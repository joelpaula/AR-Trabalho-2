...
p = <k> / (N-1)
No nosso caso concreto, o objectivo é obtermos <k> = 4, tendo N=100. Logo, a probabilidade que deverá ser usada na geração da rede aleatória é:
p = 4/(100-1) <=> p = 4/99 = 0.04 (aprox.)
...
```{r}
>>>>>>> fa233701ea986702a086f40757da9e78a01b851c
set.seed(42)
